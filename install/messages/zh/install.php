...
return [
    ...
    'Database table prefix' => '数据库数据表前缀',
    'Database host, SQLite like `/path/to/feehi.db`, other database often is localhost' => '数据库地址， SQLite为路径，如 /path/to/feehi.db，其他数据库一般为localhost',
    ...
    'Verifying, do no refresh this window.' => '正在验证配置，请勿刷新本页',
    ...
    'For your site security, please remove the directory install! and, backup common/config/main-local.php' => '为了您站点的安全，安装完成后即可将网站目录下的“install”文件夹删除!另请对common/config/main-local.php文件做好备份，以防丢失！',
    'Congratulations! Success installed' => '恭喜您,安装成功!',
    ...
    "Touch install lock file {lock_file} failed,please touch file handled" => "创建安装锁文件{lock_file}失败,请手动创建",
];