...
return array (
  ...
  'Prev' => '前へ',
  'Install' => 'インストール',
  '{attribute} cannot be empty' => '{属性}は空にできません',
  ...
  'Create table {table} finished' => 'テーブル{テーブル}の作成が完了しました',
  'Create table {table} index {index} finished' => 'テーブル{テーブル}インデックス{インデックス}の作成が完了しました',
