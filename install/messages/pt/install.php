...
return array (
  ...
  'Access to database `{database}` error. Maybe permission denied' => 'Erro de acesso ao banco de dados `{banco de dados}`. Talvez permissão negada',
  ...
  'Create table {table} finished' => 'Criar tabela {tabela} concluída',
  'Create table {table} index {index} finished' => 'Criar tabela {tabela} índice {índice} concluído',
