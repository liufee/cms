...
<section class="section">
    <div style="padding: 40px 20px;">
        <div class="text-center">
            ...
            <br>
            <a target="_blank" class="btn btn-success" href="<?=yii::$app->getRequest()->hostInfo?>"><?=yii::t('install', 'go Frontend')?></a>
            <a target="_blank" class="btn btn-success" href="<?=yii::$app->getRequest()->hostInfo?>/admin"><?=yii::t('install', 'go Backend')?></a>
        </div>
    </div>
</section>
