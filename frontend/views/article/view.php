...
<div class="content-wrap">
    <div class="content">
        ...
        <article class="article-content">
            ...
            <p><?=yii::t('frontend', 'Reproduced please indicate the source')?>：<a href="<?=yii::$app->homeUrl?>" data-original-title="" title=""><?=yii::$app->feehi->website_title?></a> » <a href="<?=Url::to(['article/view', 'id'=>$model->id])?>" data-original-title="" title=""><?=$model->title?></a></p>
        ...
        <div id="respond" class="no_webshot">
            ...
            <?php $form = ActiveForm::begin();?>
                ...
                <div class="comt-title" style="display: block;">
                    ...
                    <div class="comt-author pull-left"><?php if(yii::$app->user->isGuest){echo '游客';}else{echo yii::$app->user->identity->username;} ?> <span><?=yii::t('frontend', 'Post my comment')?></span> &nbsp;
                ...
                <div class="comt">
                    <div class="comt-box">
                        <?=$form->field($commentModel, 'content', ['template'=>'{input}'])->textarea(['class'=>'input-block-level comt-area', 'cols'=>'100%', 'rows'=>'3', 'tabindex'=>1, 'placeholder'=>yii::t('frontend', 'Writing some...'), "id"=>"comment"]) ?>
                        <div class="comt-ctrl">
                            <button class="btn btn-primary pull-right" type="submit" name="submit" id="submit" tabindex="5"><i class="fa fa-check-square-o"></i> <?=yii::t('frontend', 'Submit comment')?></button>
                    ...
                    <div class="comt-comterinfo" id="comment-author-info" style="display:none">
                        ...
                        <ul>
                            ...
                            <li class="form-inline"><?= $form->field($commentModel, 'website_url', ['template'=>'{input}<span class="help-inline">'.yii::t('frontend', 'Website').'</span>'])->textInput() ?></li></li>
                        </ul>
                    </div>
                </div>
            <?php ActiveForm::end() ?>
