...
<div class="middle-box text-center loginscreen  animated fadeInDown">
    ...
    <div>
        ...
        <?php $captcha = Captcha::widget(['name'=>'captchaimg',
            ...
            'template'=>'{image}']);
        ?>
        <?=$form->field($model, 'captcha', ['template'=>'<div style="position:relative">{input}'.$captcha.'{error}{hint}</div>'])->textInput(['placeholder'=>yii::t("app", "Captcha"), 'style'=>'width:200px'])?>
